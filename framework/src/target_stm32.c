...
//----------------------------------------
	...
	{"s01",			&runtime.self.id.clue,						2, 1,	1,	1,	0xffef},
	{"s02",			&runtime.self.port_num,						2, 1,	2,	0,	0xffff},
	{"s03",			&runtime.self.advertise_rate,				4, 100,	3,	0,	0x00ffffff},
	{"s04",			&runtime.self.refresh_rate,					4, 100,	4,	0,	0x00ffffff},
	{"s05",			&runtime.self.neighbor_deletion,			4, 100,	5,	0,	0x00ffffff},
	{"s06",			&runtime.self.table_item_expiration,		4, 100,	6,	0,	0x00ffffff},
	{"s07",			&runtime.self.table_item_deletion,			4, 100,	7,	0,	0x00ffffff},
	{"s08",			&runtime.self.channel,						1, 1,	8,	33,	60},
	{"s09",			&runtime.self.is_one_way,					1, 1,	9,	0,	1},
	{"s0a",			&runtime.self.one_way_target.clue,			2, 1,	10,	1,	0xffef},
	{"s0b",			&runtime.self.priority,						1, 1,	11,	0,	255},
	{"s0c",			&runtime.self.rssi_filter_threshold,		1, 1,	12,	0,	255},
	{"s0d",			&runtime.self.scope,						1, 1,	13,	0,	255},
	{"s0e",			&gShowRoute,								1, 1,	14,	0,	1},
	{"s0f",			&runtime.self.is_accept_sync,				1, 1,	15,	0,	1},
	{"s10",			&runtime.self.is_answer_rreq,				1, 1,	16,	0,	1},
	{"s11",			&runtime.self.is_forward_rreq,				1, 1,	17,	0,	1},
	{"s12",			&runtime.self.broadcast_send_jitter,		4, 1,	18,	0,	0xffff},
	{"s13",			&gShowNotify,								1, 1,	19,	0,	1},
	{"s14",			&runtime.self.echo_back_interval,			4, 100,	20,	0,	0x00ffffff},
	{"s15",			&runtime.self.max_echo_back_wait,			4, 100,	21,	0,	0x00ffffff},
	{"s16",			&gIsSyncSleep,								1, 1,	22,	0,	1},
	{"s17",			&runtime.router.auto_ans_wait,				4, 100,	23,	0,	0x00ffffff},
	{"s18",			&runtime.router.auto_ans_wait_times,		1, 1,	24,	0,	255},
	{"s19",			&gShowRcvData,								1, 1,	25,	0,	1},
	{"s1a",			&runtime.self.is_discover_route,			1, 1,	26,	0,	1},
	{"s1b",			&runtime.self.use_priority_list,			1, 1,	27,	0,	1},
	{"s1c",			&runtime.inquiry_context.is_accept_pairing,	1, 1,	28,	0,	1},
	{"s1d",			&gEchoBack,									1, 1,	29,	0,	1},
	{"s1e",			&gShowCalib,								1, 1,	30,	0,	1},
	{"s1f",			&runtime.self.calibration,					2, 1,	31,	-500,	500},
	{"s20",			&gAutoLoad,									1, 1,	32,	0,	1},
	{"s21",			&runtime.self.stats.total_send_time,		4, 1,	33,	0,	0},
	{"s22",			&gPanID,									2, 1,	34,	0,	0xffff},
	{"s23",			&runtime.inquiry_context.is_answer_inquiry,	1, 1,	35,	0,	1},
	{"s24",			&runtime.self.is_security_enable,			1, 1,	36,	0,	1},
	{"s25",			&runtime.self.stats.is_under_limit,			1, 1,	37,	0,	0},
	{"s26",			&runtime.self.auto_ans_delay,				4, 100,	38,	0,	0x00ffffff},
	{"s27",			&runtime.self.rans_expiration,				4, 100,	39,	0,	0x00ffffff},
	{"s28",			&runtime.self.is_sync_advertise,			1, 1,	40,	0,	1},
	{"sff",			&runtime.self.stats.is_send_limit_enabled,	1, 1,	255,	0,	1},
	{"erxorigin",	&erxorigin,									2, 1,	-1,	1,	0xffff},
	{"erxdst",		&erxdst,									2, 1,	-1,	1,	0xffff},
	{"erxmsgid",	&erxmsgid,									2, 1,	-1,	1,	0xffff},
	{"erxselector",	&erxselector,								2, 1,	-1,	1,	0xffff},
	{"erxrssi",		&erxrssi,									1, 1,	-1,	1,	0xffff},
	{"erxlen",		&erxlen,									2, 1,	-1,	1,	0xffff},
	{"eackstatus",	&eackstatus,								1, 1,	-1,	1,	0xffff},
	{"eackdst",		&eackdst,									2, 1,	-1,	1,	0xffff},
	{"eackmsgid",	&eackmsgid,									2, 1,	-1,	1,	0xffff},
#endif
